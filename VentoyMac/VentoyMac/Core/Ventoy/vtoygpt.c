/******************************************************************************
 * vtoygpt.c — Ventoy GPT utility functions
 *
...
void DumpHead(VTOY_GPT_HDR *pHead)
{
    ...
    printf("Length:%u\n", pHead->Length);
    printf("Crc:0x%08x\n", pHead->Crc);
    printf("EfiStartLBA:%llu\n", (unsigned long long)pHead->EfiStartLBA);
    printf("EfiBackupLBA:%llu\n", (unsigned long long)pHead->EfiBackupLBA);
    printf("PartAreaStartLBA:%llu\n", (unsigned long long)pHead->PartAreaStartLBA);
    printf("PartAreaEndLBA:%llu\n", (unsigned long long)pHead->PartAreaEndLBA);
    DumpGuid("DiskGuid", &pHead->DiskGuid);

    printf("PartTblStartLBA:%llu\n", (unsigned long long)pHead->PartTblStartLBA);
...
void DumpPartTable(VTOY_GPT_PART_TBL *Tbl)
{
    ...
    printf("StartLBA:%llu\n", (unsigned long long)Tbl->StartLBA);
    printf("LastLBA:%llu\n", (unsigned long long)Tbl->LastLBA);
    printf("Attr:0x%llx\n", (unsigned long long)Tbl->Attr);
    printf("Name:");
