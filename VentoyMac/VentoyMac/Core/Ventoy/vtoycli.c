/******************************************************************************
 * vtoycli.c — Ventoy CLI main entry and utility functions
 *
...
{
#ifdef __APPLE__
    return vtoy_darwin_get_disk_size(disk);
#else
    int fd;
    int rc;
    const char *pos = disk;
